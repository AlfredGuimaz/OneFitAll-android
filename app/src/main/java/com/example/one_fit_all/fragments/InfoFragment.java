...
import com.example.one_fit_all.databinding.FitbitLayoutInfoBinding;
...
public abstract class InfoFragment<T> extends Fragment implements LoaderManager.LoaderCallbacks<ResourceLoaderResult<T>>, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected FitbitLayoutInfoBinding binding;
    protected final String TAG = getClass().getSimpleName();

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fitbit_layout_info, container, false);
    ...
    protected void setMainText(String text) {
        Log.d("InfoFragment","--------------setmaintext:"+text.toString());
        binding.htmlWebView.loadData(text, "text/html", "UTF-8");
    }
